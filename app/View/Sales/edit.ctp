	...
	<div id="sidebar" class="col-sm-3">
		...
		<li class="list-group-item"><?php echo $this->Html->link(__('List Users'), array('action' => 'index'), array('class' => '')); ?> </li>
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
		<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete Sale'), array('controller' => 'sales','action' => 'delete', $this->Form->Value('Sale.id')),null, __('Are you sure you want to delete # %s?', $this->Form->Value('Sale.id'))); ?> </li>
		...
		<div class="sales form">
			...
			<?php echo $this->Form->create('Sale', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<?php echo $this->Form->input('sale_total_value', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
